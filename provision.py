...
class Credentials:
    ...
    def __str__(self):
        self._logger.debug('Host={};User={};Password={}'.format(self._host, self._user, self._password))
        return 'Host={};User={};Password={}'.format(self._host, self._user, self._password)


class ProvisioningClient():

    def __init__(self, scope_id, registration_id, credentials_type: IoTCConnectType, credentials, logger, model_id=None,
    ...
    def register(self):
        ...
        self._logger.debug(response.__dict__)
    ...
    def _loop_assignment(self, operation_id):
        ...
        self._logger.debug(self._endpoint)
        self._logger.debug(self._scope_id)
        self._logger.debug(self._registration_id)
        self._logger.debug(operation_id)
        self._logger.debug(self._api_version)
        ...
        if response.status_code == 202:
            ...
            assigned_hub = 'asgoerni-iot-hub.azure-devices.net'
            response.close()
            ...
            return Credentials(assigned_hub,
                               '{}/{}/?api-version=2019-03-30'.format(assigned_hub, self._registration_id),
